...
def get_data(filters):
	...
	return frappe.db.sql('''select item_name, qty, amount from `tabPurchase Invoice Item` where creation>=%s and creation<=%s group by item_name order by qty desc''',(from_date, to_date))